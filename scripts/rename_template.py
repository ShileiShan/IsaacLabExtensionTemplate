...
It renames all the occurrences of rlDemo (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the rlDemo folder
        os.rename(
            os.path.join(root_dir_path, "exts", "rlDemo", "rlDemo"),
            os.path.join(root_dir_path, "exts", "rlDemo", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "rlDemo"), os.path.join(root_dir_path, "exts", new_name))
